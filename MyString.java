...
public class MyString {
    public static void main(String args[]) {
        ...
        System.out.println(subsetOf("runi", "rnnt"));
        System.out.println(subsetOf("runii", "runi"));
    ...
    // funcation that gets 2 string and return true if thet equals without considerd
    // if they have lower case or upper case letters
